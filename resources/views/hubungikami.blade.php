        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" class="space-y-8">
                    ...
                    <button type="submit"
                        class="py-3 px-5 text-sm font-medium text-center text-blue rounded-lg bg-blue-600 sm:w-fit hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 border border-blue-900">
                        Send message
                    </button>
                </form>
            </div>
